 ...
 * @author YVON
 */
public class Statistics3Controller implements Initializable {
@FXML
    ...
    double  variance, mean, successes,diff, diff_plus, diff_minus, z, st_dev = 0;
    ...
    void getClear() {
     ...
     private void getPercent(double z, String percent) {
        ...
        double mean_percent = Double.valueOf(txt_mean.getText()) /100;

        //mean
        successes = mean_percent * sampleSize;
        String successes_string = Double.toString(successes);
        lbl_success.setText(successes_string);

        //Standard deviation
        st_dev = Math.sqrt((mean_percent*(1-mean_percent))/sampleSize);
   ...
   @Override
    public void initialize(URL url, ResourceBundle rb) {
       ...
       @FXML
    private void Back3Action(ActionEvent event) {
